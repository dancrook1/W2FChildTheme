...
<div class="component_options_select_wrapper" <?php echo $hide_dropdown ? 'style="display:none;"' : ''; ?>>
    <select id="component_options_<?php echo esc_attr( $component_id ); ?>" 
            class="component_options_select wc-composite-select2" 
            name="wccp_component_selection[<?php echo esc_attr( $component_id ); ?>]"
            data-placeholder="<?php esc_attr_e('Select an option', 'woocommerce'); ?>">
    </select>
</div>
