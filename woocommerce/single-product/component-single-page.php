...
?><div id="component_<?php echo esc_attr( $component_id ); ?>" class="<?php echo esc_attr( implode( ' ', $component_classes ) ); ?> component-tab-wrapper" data-nav_title="<?php echo esc_attr( $component->get_title() ); ?>" data-item_id="<?php echo esc_attr( $component_id ); ?>" style="display:none;">
